...
<div class="card" style="overflow-x: auto">
    <table>
        ...
        <tbody>
        <?php if (empty($links)): ?>
        <tr><td colspan="16" class="text-muted">Belum ada link TikTok.</td></tr>
        <?php endif; ?>
        ...
        <tr>
            ...
            <td><?= esc($link['segment'] ? ucfirst($link['segment']) : '-') ?></td>
            <td><?= esc($link['gender'] ? ucfirst($link['gender']) : '-') ?></td>
            <td><?= $link['budget'] !== null ? 'Rp ' . number_format((float) $link['budget'], 0, ',', '.') : '-' ?></td>
